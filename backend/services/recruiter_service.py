...
class RecruiterService:
    ...
    def get_dashboard_stats(self, recruiter_id: int) -> Dict:
        ...
        try:
            ...
            # Match percentage can be NULL for "Resume Only" analyses; ignore those.
            ...
            match_scores = [a.job_match_percentage for a in analyses if a.job_match_percentage is not None]
