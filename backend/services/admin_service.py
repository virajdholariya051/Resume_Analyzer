"""
Admin service - aggregations for the admin dashboard and management pages.

Provides KPI computation, user-growth / upload time-series, recruiter
    ...
    def get_overview_kpis(self) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "role_distribution": {
                    "Job Seekers": role_counts.get("Job Seeker", 0),
